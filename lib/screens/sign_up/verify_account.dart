import 'package:ecotrack_mobile/screens/smartplug/smart_plug_selection.dart';
  ...
  Future<void> verifyOtp() async {
    ...
    if (response.statusCode == 200) {
      ...
      Navigator.pushReplacement(
        context,
        MaterialPageRoute(builder: (context) => const SmartPlugSelectionPage()),
      );
    } else {
      ScaffoldMessenger.of(context).showSnackBar(
            ...
            child: SingleChildScrollView(
              ...
              child: Column(
                ...
                children: [
                  ...
                  const Text("We just sent an OTP code to your email", style: TextStyle(color: Colors.black54)),
                  Text(
                    widget.email,
                  ...
                  Container(
                    ...
                    child: Column(
                      children: [
                        ...
                        _secondsRemaining > 0
                            ? Text("Resend after ${_secondsRemaining}s", style: const TextStyle(color: Colors.black45))
                            : TextButton(
                                onPressed: resendOtp,
